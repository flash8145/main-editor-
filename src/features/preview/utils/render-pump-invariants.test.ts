...
function createPumpSimulation() {
  ...
  return {
    get inFlight() {
      return scrubRenderInFlight
    },
    get generation() {
      return scrubRenderGeneration
    },
    get pumpCallCount() {
      return pumpCallCount
    },
    get maxConcurrentPumps() {
      return maxConcurrentPumps
    },
    get staleFinallyReleases() {
      return staleFinallyReleases
    },
    get renderedFrames() {
      return renderedFrames
    },
    set renderDelayMs(ms: number) {
      renderDelayMs = ms
    },
    setRequestedFrame(frame: number) {
      scrubRequestedFrame = frame
    },
    bumpGeneration() {
